"""add clean_title to job_offers

Revision ID: a13e1727640f
Revises: ebeebf00d8d7
Create Date: 2026-04-14 06:29:39.068209
...
revision: str = 'a13e1727640f'
down_revision: Union[str, Sequence[str], None] = 'ebeebf00d8d7'
...
def upgrade() -> None:
    ...
    op.add_column('job_offers', sa.Column('clean_title', sa.String(length=200), nullable=True))
    op.alter_column('job_offers', 'application_date',
...
def downgrade() -> None:
    ...
    op.alter_column('job_offers', 'application_date',
               existing_type=postgresql.TIMESTAMP(timezone=True),
               nullable=False)
    op.drop_column('job_offers', 'clean_title')
