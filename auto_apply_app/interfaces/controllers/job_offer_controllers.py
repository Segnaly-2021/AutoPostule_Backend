...
class JobOfferController:
    ...
    async def handle_toggle_response(self, job_id: str, user_id: str, status: bool) -> OperationResult:
        try:
            request_dto = ToggleStatusRequest(job_offer_id=job_id, user_id=user_id, has_response=status, has_interview=False)
    ...
    async def handle_toggle_interview(self, job_id: str, user_id: str, status: bool) -> OperationResult:
        try:
            request_dto = ToggleStatusRequest(job_offer_id=job_id, user_id=user_id, has_response=False, has_interview=status)
